      ...
      <div className="cosplan-shell">
        <div className="closet-header-bar transition-shadow duration-300 hover:shadow-closet-lg">
          ...
          <div className="hidden items-center gap-2 sm:flex">
            ...
            <Link href="/contact" className="closet-header-btn">
        ...
        {menuOpen && (
          <nav className="mt-3 flex animate-scale-in flex-col gap-1 rounded-3xl border border-closet-rose/20 bg-closet-rose px-4 py-4 shadow-closet-lg xl:hidden">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
            ...
            <Link
              href="/contact"
              className={`rounded-xl px-4 py-3 text-center text-sm font-semibold transition-colors hover:bg-white/15 ${
                isActive(pathname, "/contact") ? "bg-white/15 text-white" : "text-white/95"
              }`}
            >
              Contact
            </Link>
